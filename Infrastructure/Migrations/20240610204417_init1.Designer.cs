...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240610204417_init1")]
    partial class init1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domin.Models.Apartment", b =>
                {
                    ...
                    b.Property<int>("RoyalDocumentID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ApartmentVideoID")
                        .IsUnique();

                    b.HasIndex("OwnerId");

                    b.HasIndex("RoyalDocumentID")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domin.Models.Apartment", b =>
                {
                    b.HasOne("Domin.Models.ApartmentVideo", "ApartmentVideo")
                        .WithOne("Apartment")
                        .HasForeignKey("Domin.Models.Apartment", "ApartmentVideoID")
                    ...
                    b.HasOne("Domin.Models.RoyalDocument", "RoyalDocument")
                        .WithOne("Apartment")
                        .HasForeignKey("Domin.Models.Apartment", "RoyalDocumentID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domin.Models.UserApartmentsRequests", b =>
                {
                    b.HasOne("Domin.Models.Apartment", "Apartment")
                        .WithOne()
                        .HasForeignKey("Domin.Models.UserApartmentsRequests", "ApartmentID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Domin.Models.ApplicationUser", "ApplicationUser")
                        .WithOne()
                        .HasForeignKey("Domin.Models.UserApartmentsRequests", "UserID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
