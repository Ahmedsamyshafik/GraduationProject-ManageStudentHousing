        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoyalDocumentID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Apartment_apartmentVideos_ApartmentVideoID",
                        column: x => x.ApartmentVideoID,
                        principalTable: "apartmentVideos",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Apartment_royalDocuments_RoyalDocumentID",
                        column: x => x.RoyalDocumentID,
                        principalTable: "royalDocuments",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Apartment_ApartmentVideoID",
                table: "Apartment",
                column: "ApartmentVideoID",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Apartment_RoyalDocumentID",
                table: "Apartment",
                column: "RoyalDocumentID",
                unique: true);
